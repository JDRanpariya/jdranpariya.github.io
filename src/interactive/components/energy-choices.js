...
export async function setup({ container, theme, utils }) {
  ...
  intro.textContent = 'You\'re designing a robot for household tasks. You can optimize for one thing. What do you choose?';
  ...
  return {
    ...
    onThemeChange(newTheme) { /* colors come from CSS */ },
  };
}

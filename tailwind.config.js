  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        h2: [
          "clamp(1.875rem, 2vw + 1rem, 2.5rem)",
          { lineHeight: "1.1", letterSpacing: "-0.03em" },
        ],
        h3: [
          "clamp(1.5rem, 1vw + 1rem, 1.875rem)",
          { lineHeight: "1.2", letterSpacing: "-0.025em" },
        ],
        h4: ["1.375rem", { lineHeight: "1.3", letterSpacing: "-0.02em" }],
        lead: ["clamp(1.125rem, 0.5vw + 1rem, 1.25rem)", { lineHeight: "1.65" }],
        body: ["clamp(1.125rem, 0.5vw + 1rem, 1.25rem)", { lineHeight: "1.75" }],
